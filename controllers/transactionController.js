...
const transactionController = {
  successfulTransaction: async (req, res) => {
    ...
    try {
      ...
      console.log(successfulTransactionNumber);
        ...
        res.send(`
          ...
          //   </h4>
            ...
            <div
              ...
              <img src="https://drive.google.com/thumbnail?id=1Ui9yWmcjwGWMowV9v5DpCApBNeW4sa58" alt="GodImage" width="320" height="300" />
  ...
  AAATL4175HF2014<br />
  CTS No. 1098 Budhwar Peth, Pune 411 002  </div>
