...
const receiptController = {
  ...
  createOrder: async (req, res) => {
    try {
      ...
      const userId = "Pratap251";

      const data = {};
      const orderbody = {};
      data["encryptText"] = JSON.stringify({
        userId: "Pratap251",
        password: "Cft.billing@123",
      });
      ...
      requestBody["encryptText"] = JSON.stringify({
        ...
        status: "A",
        createdBy: "Randeep",
        successURL: `https://y6ppzb.deta.dev/transaction/success/${fName}?amount=${amount}&pawti=${pawti}`,
        failureURL: `https://y6ppzb.deta.dev/transaction/failed/${fName}?amount=${amount}&pawti=${pawti}`,
      });
      // console.log("Here is requestBody:",requestBody)
      var userEncryption = encode("Pratap251", userIdSecret);
      ...
      const createOrder = await axios.post(
        ...
        `https://www.avantgardepayments.com/agmerchant/sdk/mediaPaymentsv2/userId/Pratap251`,
  ...
  sendmail: (req, res) => {
    new Promise((resolve, reejct) => {
      ...
      const mailOptions = {
        ...
        to: "kaustubhpardhi006@gmail.com",
        subject: "testing",
        text: "testing mail",
      };
